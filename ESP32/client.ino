...
const char *PWD = "MurBen3128";//"12345678"; //

/*LASER GPIO pin*/
int LASER_PIN_PLUS = 16;// 22;
int LASER_PIN_MINUS = 17;//23;
int LED_PIN = 2;
...
void set_laser() {
  ...
  // apply a nonlinear look-up table
  int lensval = (int)(pow(((float)(value) / (float)pwm_max), 2) * (float)pwm_max);
  ledcWrite(PWM_CHANNEL_LASER, lensval);
  Serial.print("Lens (right) Y is set to: ");
  Serial.print(lensval);
  Serial.println();
